...
export const $input = /*#__PURE__*/ l.jsonPayload({"space":/*#__PURE__*/ l.string({"format":"uri"}),"repo":/*#__PURE__*/ l.string({"format":"did"}),"collection":/*#__PURE__*/ l.string({"format":"nsid"}),"rkey":/*#__PURE__*/ l.string({"format":"record-key"})});
