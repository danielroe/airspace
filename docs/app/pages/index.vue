...
useSeoMeta({
  title: 'airspace: the CMS you already have',
  description: 'Your atproto account is the database. Records in your own repo, drafts in permissioned spaces, typed from your schema.',
  ogTitle: 'airspace',
  ogDescription: 'The CMS you already have.',
...
<template>
  <div class="landing">
    <section class="hero">
      <h1>the CMS you already&nbsp;have.</h1>

      <p class="lede">
        every <s>Bluesky</s> <span>atmosphere</span> account comes with a personal data server: a database, login, file storage and a
        public API that you own and can move.
      </p>
